...
def build_ID3(dataset: pd.DataFrame, label_index: int):
    ...
    current_best_feature = Information_Gain.calculate_all_infomation_gain(
    ...
    for i in feature_count:
        ...
        result_tree[current_best_feature][i] = build_ID3(
...
print(data)
print(Information_Gain.calculate_all_infomation_gain(data, -1))
print(build_ID3(data, -1))
